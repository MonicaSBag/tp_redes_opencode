...
- Música de ambiente generada con Web Audio (sin archivos externos), activa por defecto desde el inicio: en la barra superior hay un botón de parlante para silenciarla/reactivarla, con deslizador de volumen.
